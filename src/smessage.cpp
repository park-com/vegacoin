// Copyright (c) 2014 The Vegacoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("vegacoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("vegacoin-smsg-pow"); // Make this thread recognisable
