...
void StatisticsPage::updateStatistics()
{
    ...
    int64_t volume = ((pindexBest->nMoneySupply)/6,000,000,000);
    ...
    {
        subsidy = "300 VEGA per block";
    }
	else if (pindexBest->nHeight < 2000000)
    {
        subsidy = "200 VEGA per block";
    }
	else if (pindexBest->nHeight < 3000000)
    {
        subsidy = "100 VEGA per block";
    }
    else if (pindexBest->nHeight > 3000000)
    {
        subsidy = "Full PoS";
    ...
    {
        ui->volumeBox->setText("<b><font color=\"yellow\">" + qVolume + " VEGA" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " VEGA" + "</font></b>");
    } else {
        ui->volumeBox->setText("<b><font color=\"orange\">" + qVolume + " VEGA" + "</font></b>");
    }
